...
struct ContentView: View {
    ...
    @State private var isAppointmentListPresented = false
    ...
    var body: some View {
            ...
            VStack {
                HStack {
                    ...
                    Image(systemName: "person.circle")
                        ...
                        .padding(.trailing, 20)
                        .onTapGesture {
                                                    // Show the appointment list when the user taps on their image
                                                    isAppointmentListPresented = true
                                                }
                }
        ...
        }.sheet(isPresented: $isAppointmentListPresented) {
            AppointmentListView()
        }
    }
}
